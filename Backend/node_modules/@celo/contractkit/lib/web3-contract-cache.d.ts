...
export declare class Web3ContractCache {
    ...
    getStableToken(stableToken?: StableToken): Promise<NonNullable<import("@celo/abis/web3/Registry").Registry | import("@celo/abis/web3/Accounts").Accounts | import("@celo/abis/web3/IERC20").IERC20 | import("@celo/abis/web3/GoldToken").GoldToken | import("@celo/abis/web3/mento/StableToken").StableToken | import("@celo/abis/web3/Attestations").Attestations | import("@celo/abis/web3/BlockchainParameters").BlockchainParameters | import("@celo/abis/web3/DoubleSigningSlasher").DoubleSigningSlasher | import("@celo/abis/web3/DowntimeSlasher").DowntimeSlasher | import("@celo/abis/web3/Election").Election | import("@celo/abis/web3/EpochRewards").EpochRewards | import("@celo/abis/web3/Escrow").Escrow | import("@celo/abis/web3/FederatedAttestations").FederatedAttestations | import("@celo/abis/web3/FeeCurrencyWhitelist").FeeCurrencyWhitelist | import("@celo/abis/web3/Freezer").Freezer | import("@celo/abis/web3/FeeHandler").FeeHandler | import("@celo/abis/web3/MentoFeeHandlerSeller").MentoFeeHandlerSeller | import("@celo/abis/web3/UniswapFeeHandlerSeller").UniswapFeeHandlerSeller | import("@celo/abis/web3/0.8/GasPriceMinimum").GasPriceMinimum | import("@celo/abis/web3/Governance").Governance | import("@celo/abis/web3/LockedGold").LockedGold | import("@celo/abis/web3/MultiSig").MultiSig | import("@celo/abis/web3/OdisPayments").OdisPayments | import("@celo/abis/web3/Random").Random | import("@celo/abis/web3/mento/Reserve").Reserve | import("@celo/abis/web3/SortedOracles").SortedOracles | import("@celo/abis/web3/Validators").Validators | undefined>>;
