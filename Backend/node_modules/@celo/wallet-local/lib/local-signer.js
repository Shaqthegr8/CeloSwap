...
class LocalSigner {
    ...
    signTransaction(addToV, encodedTx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signature = eth_lib_1.account.makeSigner(addToV)(hash, this.privateKey);
            return (0, wallet_base_1.decodeSig)(signature);
        });
    }
    ...
    decrypt(ciphertext) {
        const decryptedPlaintext = (0, ecies_1.Decrypt)(Buffer.from((0, address_1.trimLeading0x)(this.privateKey), 'hex'), ciphertext);
